...
using OneHealthHandbook.Web.Security;
...
namespace OneHealthHandbook.Web
{
    ...
    public class SmtpEmailService : IIdentityMessageService
    {
        ...
        {
            var fromAddress = ConfigurationManager.AppSettings["smtpFromAddress"] ?? "noreply@OneHealthHandbook.local";
...
FROM [dbo].[AspNetUsers] u;");
        ...
        public static async Task EnsureTestUsersAsync(ApplicationDbContext dbContext)
        {
            ...
            var users = new[]
            {
                ...
                {
                    Email = "author.workflow@OneHealthHandbook.local",
                ...
                new SeedUserDefinition
                {
                    Email = "reviewer.workflow@OneHealthHandbook.local",
                ...
                new SeedUserDefinition
                {
                    Email = "admin.workflow@OneHealthHandbook.local",
