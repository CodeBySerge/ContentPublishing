...
using OneHealthHandbook.Domain.Entities;

namespace OneHealthHandbook.Infrastructure.Data
{
    public class OneHealthHandbookDbContext : DbContext
    {
        public OneHealthHandbookDbContext()
            : base("name=OneHealthHandbookDb")
        {
        }
